...
export const skillGroups: SkillGroup[] = [
  ...
  },
  {
    ...
    tone: 'info',
    note: 'Anything that should not need a person.',
    items: [
      'n8n',
      'Apache Airflow',
  ...
  },
  {
    ...
    tone: 'alt',
    note: 'Mostly built for my own setup, then reused at work.',
    items: [
      'RAG pipelines',
...
export const arc: TimelineEvent[] = [
  ...
  { year: '2024', label: 'Delivery model rewritten: 75+ microservices on governed CI/CD' },
